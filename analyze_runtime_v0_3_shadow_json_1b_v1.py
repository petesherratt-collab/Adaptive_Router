...
BOOTSTRAP_SEED = "20260909-runtime-v0.3-shadow-json-1b-v1"
...
def analyze_rows(rows, tasks, revision):
    ...
    report = {
        "schema_version": "runtime_v0_3_shadow_json_1b_analysis_v1",
...
def authenticate_complete(root=pv.ROOT, frozen_root=None):
    ...
    if (
        summary.get("schema_version") != "runtime_v0_3_shadow_json_1b_summary_v1"
