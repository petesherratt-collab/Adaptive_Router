"""Frozen schema, oracle, budget, and evidence rules for runtime v0.3 shadow JSON V1."""
...
PLAN_NAME = "RUNTIME_V0_3_SHADOW_JSON_V1_PLAN.md"
BENCHMARK_NAME = "benchmark_runtime_v0_3_shadow_json_v1.json"
CONFIG_NAME = "config.json"
PLAN_SHA256 = "acfa8f12d585a7d817afc09dec632c7346c29582b10e4fd477c9337c516eb0ed"
BENCHMARK_SHA256 = "76378d8bdeba1facb3f43f41186b2e31f091d8baea7550f10c54d42803ed0f93"
CONFIG_SHA256 = "36df214e322b8148614e0ac8289ddb77779e326e06d91e3780ea39b87bd01657"
SUITE_ID = "runtime_v0_3_shadow_json_v1"
SCHEMA_VERSION = "runtime_v0_3_shadow_json_observation_v1"
...
def validate_benchmark(document):
    ...
    if (
        document["schema_version"] != "runtime_v0_3_shadow_json_benchmark_v1"
        or document["suite_id"] != SUITE_ID
        or document["created_date"] != "2026-09-06"
...
def output_paths(root=ROOT):
    root = Path(root)
    prefix = "runtime_v0_3_shadow_json_v1_"
    return {
...
def validate_rows(rows, tasks, revision):
    ...
    for row in rows:
        ...
        if (
            ...
            or shadow.get("reason") != "MEASURED"
            or shadow.get("validator") != row.get("local_contract")
            or telemetry.get("remote_validator") != row.get("remote_contract")
...
def summary(rows, revision, budget):
    return {
        "schema_version": "runtime_v0_3_shadow_json_summary_v1",
        "suite_id": SUITE_ID,
